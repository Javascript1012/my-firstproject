                    ...
                    <div className="row gutter-35">
                        <div className="col-md-4">
                            <ContactInfo
                                ...
                                address="
                                Reader's Hub Library- Br.2 Zakeria Bundar Rd,Near Cotton Green Railway Station(W),Mumbai- 400033"
                            />
                        </div>
                        <div className="col-md-4">
                            <ContactInfo
                    ...
                    <div className="row y-middle">
                        <div className="col-lg-6 md-mb-30">
                            <div className="map-canvas">
                                <iframe src="https://maps.google.com/maps?q=readershub library Cotton Green Railway Station(W) &t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
                            </div>
                        </div>
