...
import normalLogo from '../../../assets/img/logo/logo-green.png';
import darkLogo from '../../../assets/img/logo/logo-green.png';
							...
							<div className="row y-middle">
								<div className="col-lg-2">
									<div className="logo-area hidden-md">
										<Link to="/">
											<img className="normal-logo" src={headerNormalLogo ? headerNormalLogo : normalLogo} alt="" height="1500px" width="500px"/>
											<img className="sticky-logo" src={headerStickyLogo ? headerStickyLogo : darkLogo} alt="" height="500px" width="120px"/>
										</Link>
									</div>
								</div>
