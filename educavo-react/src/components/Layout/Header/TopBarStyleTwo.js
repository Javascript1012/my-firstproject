                    ...
                    <div className="col-md-7 text-end">
                        <div className="toolbar-sl-share">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.facebook.com/readershublibrarymumbai/"><i className="fa fa-facebook-f"></i></a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://www.instagram.com/readershublibrary/?hl=en"><i className="fa fa-instagram"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
