					...
					<ul className="nav-menu">
						<li className={home ? "menu-item-has-children current-menu-item" : "menu-item-has-children"}>
							...
							<ul className={home ? "sub-menu current-menu" : "sub-menu"}>
								<li>
									<Link to="/" className={location.pathname === "/home-12" ? "active-menu" : ""}>home</Link>
								</li>
								
							</ul>
						</li><li className={contact ? "menu-item-has-children current-menu-item" : "menu-item-has-children"}>
							<Link to="#" onClick={() => { openMobileMenu('contact'); }} className={parentMenu === 'contact' ? 'active-menu' : ''}>Location</Link>
